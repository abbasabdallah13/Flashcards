...
const flashcard = ({setAllowNewFlashcard, newCardId, setNewCardId, setFlashCards, flashCards}) => {
    ...
    useEffect(() => {
      const getFlashcards = () => {
        ...
        client.fetch(query).then(data => {setOldFlashcards(data)}).catch(err => console.log(err.message));
